...
//    			var entity = HtmlEntities[entitykey];
//    			var regex = new RegExp(entitykey, 'g');
//    			query = query.replace(regex, entity);
//    			/*regexTableName = tableName.replace(regex, entity);*/
//    		}
	...
	$.ajax({
		...
		success: function(response) {
			...
			if (response != null && !jQuery.isEmptyObject(response)) {
				...
				var insightList = response.querysMap.query;
                var querysMapTemp = response['querysMap'];
                var querysMap =querysMapTemp['query'];
				var columnsListMap = response.querysMap.column;
				if (insightList != null && !jQuery.isEmptyObject(insightList) &&
					querysMap != null && !jQuery.isEmptyObject(querysMap)) {
					getInsightsView(tableName,insightList, querysMap,columnsListMap);
                 }else {
                    var modalObj = {
						title: 'Message',
...
function getInsightsView(tableName,insightsData,queryMap,columnsListMap)
{
